...
/**
 * appDevDebugProjectContainer__5164c899c6418__
 *
 * This class has been auto-generated
 * by the Symfony Dependency Injection Component.
 */
class appDevDebugProjectContainer__5164c899c6418__ extends Container
{
    /**
     * Constructor.
     */
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/cache/dev_new/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/cache/dev_new/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'backoffice', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager5164c89a14943_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager5164c89a14943_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/cache/dev_new/jms_diextra/doctrine/EntityManager_5164c89a14943.php';

        $a = $this->get('annotation_reader');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_793b14dce3e857ebb6551d0f564fb9dc');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_793b14dce3e857ebb6551d0f564fb9dc');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_793b14dce3e857ebb6551d0f564fb9dc');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/src/OVGS/BackofficeBundle/Entity', 1 => '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/src/OVGS/SecuredBundle/Entity'));

        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'OVGS\\BackofficeBundle\\Entity');
        $f->addDriver($e, 'OVGS\\SecuredBundle\\Entity');

        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('OVGSBackofficeBundle' => 'OVGS\\BackofficeBundle\\Entity', 'OVGSSecuredBundle' => 'OVGS\\SecuredBundle\\Entity'));
        $g->setMetadataCacheImpl($b);
        $g->setQueryCacheImpl($c);
        $g->setResultCacheImpl($d);
        $g->setMetadataDriverImpl($f);
        $g->setProxyDir('/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/cache/dev_new/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager5164c89a14943_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($h, $this);
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/Resources');
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '5cbe2074a632887f5d781f7ed4ce36d19014c20a');
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/cache/dev_new/jms_diextra/metadata'));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/cache/dev_new/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/cache/dev_new/assetic/routing.yml', array('cache_dir' => '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/cache/dev_new', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appdevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appdevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context'), $this->get('monolog.logger.router'));
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/cache/dev_new/jms_security/expressions');
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('OVGS\\SecuredBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 10))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/backoffice/login$'), 'security.firewall.map.context.secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $i = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $h, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($h, '/'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'secured_logout'));
        $i->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());

        $j = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($h, array('login_path' => 'secured_login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $j->setProviderKey('secured_area');

        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($g, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.chain_provider'), 1 => $this->get('security.user.provider.concrete.in_memory'), 2 => $this->get('security.user.provider.concrete.user_db')), 'secured_area', $a, $c), 2 => $i, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $h, 'secured_area', $j, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $h, array('login_path' => 'secured_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => 'secured_login_check', 'use_forward' => false, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c), 4 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $g, $f, $a)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $h, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $h, 'secured_login', false), NULL, NULL, $a));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/cache/dev_new/secure_random.seed', $this->get('monolog.logger.security'));
    }
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/cache/dev_new/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/cache/dev_new/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app', 'UTF-8');
    }
    ...
    protected function getTemplating_Helper_LogoutUrlService()
    {
        ...
        $instance->registerListener('secured_area', 'secured_logout', 'logout', '_csrf_token', NULL);
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/cache/dev_new/translations', 'debug' => true));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'cache' => '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/cache/dev_new/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
        $instance->addPath('/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/src/OVGS/BackofficeBundle/Resources/views', 'OVGSBackoffice');
        $instance->addPath('/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/src/OVGS/SecuredBundle/Resources/views', 'OVGSSecured');
        $instance->addPath('/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/src/Acme/DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/Resources/views');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('5cbe2074a632887f5d781f7ed4ce36d19014c20a');
    }
     ...
     *
     * @return EntityManager5164c89a14943_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/cache/dev_new/assetic/assets');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.chain_provider'), new \Symfony\Component\Security\Core\User\UserChecker(), 'secured_area', $this->get('security.encoder_factory'), true)), true);
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/cache/dev_new/jms_security', true));
    ...
    {
        return $this->services['security.user.provider.concrete.user_db'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'OVGSSecuredBundle:User', 'userName', NULL);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/cache/dev_new');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/cache/dev_new',
            'kernel.logs_dir' => '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/logs',
            'kernel.bundles' => array(
                ...
                'OVGSBackofficeBundle' => 'OVGS\\BackofficeBundle\\OVGSBackofficeBundle',
                'OVGSSecuredBundle' => 'OVGS\\SecuredBundle\\OVGSSecuredBundle',
            ...
            'kernel.container_class' => 'appDevDebugProjectContainer__5164c899c6418__',
            ...
            'locale' => 'en',
            'secret' => '5cbe2074a632887f5d781f7ed4ce36d19014c20a',
            'database_path' => NULL,
            ...
            'debug.container.dump' => '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/cache/dev_new/appDevDebugProjectContainer__5164c899c6418__.xml',
            ...
            'kernel.secret' => '5cbe2074a632887f5d781f7ed4ce36d19014c20a',
            ...
            'session.save_path' => '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/cache/dev_new/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/cache/dev_new/profiler',
            ...
            'router.resource' => '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/cache/dev_new/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/cache/dev_new/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.memory.path' => '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/cache/dev_new/swiftmailer/spool',
            ...
            'assetic.cache_dir' => '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/cache/dev_new/assetic',
            ...
            'assetic.read_from' => '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/../web',
            'assetic.write_to' => '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/cache/dev_new/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/cache/dev_new/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/cache/dev_new/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(

            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/cache/dev_new/jms_diextra/doctrine/EntityManager_5164c89a14943.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager5164c89a14943_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => '/Users/lucasv/Documents/Projects/local.backoffice.ovg.net/app/cache/dev_new/jms_security',
