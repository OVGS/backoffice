...
namespace OVGS\TestBundle\Entity;
...
class Module
{
     ...
     * Add role
     *
     * @param \OVGS\TestBundle\Entity\Role $role
     * @return Module
     */
    public function addRole(\OVGS\TestBundle\Entity\Role $role)
    {
        $this->role[] = $role;
     ...
     * @param \OVGS\TestBundle\Entity\Role $role
     */
    public function removeRole(\OVGS\TestBundle\Entity\Role $role)
    {
     ...
     * Set moduleCategory
     *
     * @param \OVGS\TestBundle\Entity\ModuleCategory $moduleCategory
     * @return Module
     */
    public function setModuleCategory(\OVGS\TestBundle\Entity\ModuleCategory $moduleCategory = null)
    {
     ...
     * Get moduleCategory
     *
     * @return \OVGS\TestBundle\Entity\ModuleCategory 
     */
